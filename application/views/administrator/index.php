...
<?=icon_load("pp_fav.ico")?>
    ...
    <script type="text/javascript" src="js/_cfe.js"></script>
...
<div id="mainSite">
    ...
    <div id="loginPanel">
        ...
        <div class="_content">
            <img src="<?=directory_images()?>/lp_warn.gif" alt="warning" />
            <h4 class="loginPanelInfo">Podaj dane dostępu do Panelu Administracyjnego</h4>
