...
$configs['db_user'] = "01193746_educms";
$configs['db_pass'] = "eduwebcms@WSX";
$configs['db_name'] = "01193746_educms";



/*Ustawienia kompresora CSS
	@param cscript_compressor_enabled   bool    Kompresja włączona/wyłączona  true | false
*/
